Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/172c062212508e84c80fc0e60d55440d"
{
	Properties
	{
...
#define PROP_ALPHAFRESNELALPHA 0.673
...
#define PROPM_START_GLOBALTHEMES 1
...
#define PROP_IRIDESCENCEINTENSITY 0.93
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void applyAlphaOptions(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if (float(1))
				{
					...
					holoRim = abs(lerp(1, holoRim, float(0.673)));
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.4725527,0.4725527,0.4725527,0.01960784).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.4725527,0.4725527,0.4725527,0.01960784).a;
