Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/678bb67d4d1da4e47a556b9034d08752"
{
	Properties
	{
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				if (float(1) > 0)
				{
					...
					reflections *= poiThemeColor(poiMods, float4(0.2411783,0.2411783,0.2411783,1), float(0)) * reflStr;
					#ifdef UNITY_PASS_FORWARDADD
