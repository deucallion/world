Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/7fc882a04fab44441bad84c1aad73116"
{
	Properties
	{
...
#define PROP_DETAILTEXINTENSITY 2.22
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void ApplyDetailColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				poiFragData.baseColor.rgb *= LerpWhiteTo(detailTexture * float(1) * unity_ColorSpaceDouble.rgb, poiMods.detailMask.r * float(2.22));
			}
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.4725527,0.4725527,0.4725527,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.4725527,0.4725527,0.4725527,1).a;
